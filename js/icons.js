/**
 * Pakistan-HIVSolutions Icon System
 * strictly no emojis - only premium SVG icons
 */
...
function injectIcons() {
    ...
    iconElements.forEach(el => {
        ...
        if (icons[iconName]) {
            ...
            // Remove the attribute once injected to avoid double processing if needed
...
window.injectIcons = injectIcons; // Expose for dynamic content
